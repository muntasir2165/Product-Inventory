...
public class EditorActivity extends AppCompatActivity implements
    ...
    /** Button field to call the product's supplier phone number */
    private Button mSupplierPhoneNumberButton;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // By default, the supplier phone call button is hidden
        mSupplierPhoneNumberButton = (Button) findViewById(R.id.call_product_supplier);
        mSupplierPhoneNumberButton.setVisibility(View.GONE);
        ...
        if (mCurrentProductUri == null) {
            ...
            // Show the Supplier Phone Call Button to make phone calls
            mSupplierPhoneNumberButton.setVisibility(View.VISIBLE);
    ...
    /**
     * Helper method to increment and decrement product quantity
     */
    public void changeProductQuantity(View v) {
        //Get the previous value first
        String quantityString = mQuantityTextView.getText().toString().trim();
        int oldValue = 0;
        if (!TextUtils.isEmpty(quantityString)) {
            oldValue = Integer.valueOf(mQuantityTextView.getText().toString());
        }

        int newValue = oldValue;
        if (v.getId() == R.id.decrease_quantity && oldValue > 0) {
            newValue = oldValue - 1;
        } else if (v.getId() == R.id.increase_quantity) {
            newValue++;
        }

        mQuantityTextView.setText(Integer.toString(newValue));
    }

    /**
     * Helper method to call product supplier
     */
    public void callProductSupplier(View v) {
        //Get the product supplier phone number
