...
/**
 * {@link ContentProvider} for Product Inventory app.
 */
public class ProductProvider extends ContentProvider {
    ...
    /** URI matcher code for the content URI for the product inventory table */
    private static final int PRODUCTS = 100;

    /** URI matcher code for the content URI for a single product in the product inventory table */
    ...
    static {
        ...
        // of the product inventory table.
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs,
        ...
        switch (match) {
            case PRODUCTS:
                // For the PRODUCTS code, query the product inventory table directly with the given
                // projection, selection, selection arguments, and sort order. The cursor
                // could contain multiple rows of the product inventory table.
            ...
            case PRODUCT_ID:
                ...
                // This will perform a query on the product inventory table where the _id equals 3 to return a
    ...
    private Uri insertProduct(Uri uri, ContentValues values) {
        ...
        String supplier_phone_number = values.getAsString(ProductEntry.COLUMN_PRODUCT_SUPPLIER_PHONE_NUMBER);
